...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (dragonHealth <= 0) {
				...
				// 		dragon have left.
			JOptionPane.showMessageDialog(null, "The dragons health is "+dragonHealth+" The players health is "+playerHealth+");
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You failed, n00b. No treasure for you.");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "Good job. +1000 gold!");
		System.exit(0);   //This code ends the program
	}
